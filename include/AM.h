...
#define AME_OK 0
#define AM_EOF -1
#define AM_OPEN_FILES_LIMIT_ERROR -2            /* Υπάρχουν ήδη BF_MAX_OPEN_FILES αρχεία ανοικτά */
#define AM_WRONG_OP -3                  /*lathos operator*/
#define AM_SCANINDEX_NOENTRY -4                  /*h scanindex de vrhke eggrafh*/
#define AM_FINDNEXTENTRY_NOENTRY -5            /*den yparxei next entry*/
#define AM_SCANINDEX_ERROR -6                 /*den exei ginei h scanindex*/
#define AM_NOTAMFILE -7                      /*den einai am arxeio*/
#define AM_BF -8                             /*lathi bf epipedou*/
#define AM_MAXSCANS -9
#define AM_INVALID_FILE_ERROR -10
